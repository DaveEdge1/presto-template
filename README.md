...
_This section is auto-regenerated by `.github/workflows/update-readme.yml`
on every successful reconstruction; the seed content below is just a
placeholder until that workflow first fires._
